...
(function() {
  ...
  $(document).ready(function() {
    ...
    calculateScore = function() {
      ...
      return $("#results").append('<h4 class="alert-heading">Results</h4><span class="badge badge-success">' + correct + '</span> correct<br><span class="badge badge-important">' + incorrect + '</span> incorrect<br><br><a href="warning-signs.html" class="btn">Restart</a>');
    };
    $("input:radio").click(function() {
      var chosenAnswer, correctAnswer;
      ...
      if (correctAnswer === chosenAnswer) {
        ...
        if (!$(this).parents("fieldset").find("legend").hasClass("incorrect")) {
          $(this).parents("fieldset").find("legend").addClass("correct");
        }
        return $(this).parents("form").find('.next').show();
      } else {
        $(this).parents("label").addClass("red");
        return $(this).parents("fieldset").find("legend").addClass("incorrect");
      }
    });
    return $(".next").click(function(e) {
      ...
      if (current.hasClass("last")) {
        ...
        $(".next").unbind();
        return $("input:radio").unbind();
      } else {
        current.removeClass("current").hide("slide", {
          direction: "left"
        }, 400);
        return next.delay(400).show("slide", {
          direction: "right"
